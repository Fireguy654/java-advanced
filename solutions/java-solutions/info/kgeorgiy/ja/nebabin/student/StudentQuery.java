 ...
 * students ordered by {@link Student#getLastName() last name} in ascending order;
 * students with equal last names are ordered by {@link Student#getFirstName() first name} in ascending order;
 * students having equal both last and first names are ordered by {@link Student#getId() id} in descending order.
 *
